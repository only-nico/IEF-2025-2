module.exports = {
    ...
    destinationColumns: [
        [
            { operationName: 'fixed-dornersito', destinationColumn: 'D', fixedCell: 'M{21}'},
        ...
        [
            { operationName: 'fixed-dornersito', destinationColumn: 'D', fixedCell: 'M{24}'},
            { operationName: 'formula', destinationColumn: 'F', formula: '=({factorEmisionNo_CO2})'}, // 
            { operationName: 'formula', destinationColumn: 'G', formula: '=(D{row}*F{row})'}, 
        ],
        [
            { operationName: 'fixed-dornersito', destinationColumn: 'D', fixedCell: 'M{27}'},
            { operationName: 'formula', destinationColumn: 'F', formula: '=({factorEmisionNo_CO2})'}, // 
            { operationName: 'formula', destinationColumn: 'G', formula: '=(D{row}*F{row})'}, 
        ],
        [
            { operationName: 'fixed-dornersito2', destinationColumn: 'D', fixedCell: 'M{21}'},
            { operationName: 'formula', destinationColumn: 'F', formula: '=({factorEmisionNo_CO2})'}, // 
            { operationName: 'formula', destinationColumn: 'G', formula: '=(D{row}*F{row})'}, 
        ],
        [
            { operationName: 'fixed-dornersito2', destinationColumn: 'D', fixedCell: 'M{24}'},
            { operationName: 'formula', destinationColumn: 'F', formula: '=({factorEmisionNo_CO2})'}, // 
            { operationName: 'formula', destinationColumn: 'G', formula: '=(D{row}*F{row})'}, 
        ],
        [
            { operationName: 'fixed-dornersito2', destinationColumn: 'D', fixedCell: 'M{27}'},
            { operationName: 'formula', destinationColumn: 'F', formula: '=({factorEmisionNo_CO2})'}, // 
            { operationName: 'formula', destinationColumn: 'G', formula: '=(D{row}*F{row})'}, 
        ],
        [
            { operationName: 'fixed-dornersito2', destinationColumn: 'D', fixedCell: 'M{30}'},
            { operationName: 'formula', destinationColumn: 'F', formula: '=({factorEmisionNo_CO2})'}, // 
            { operationName: 'formula', destinationColumn: 'G', formula: '=(D{row}*F{row})'}, 
        ]
    ],
